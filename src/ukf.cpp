...
UKF::UKF() {
	...
	std_las_px_ = 0.15;  // Laser measurement noise standard deviation position1 in m
	std_las_py_ = 0.15;  // Laser measurement noise standard deviation position2 in m

	std_rad_r_ = 0.3;  // Radar measurement noise standard deviation radius in m
	std_rad_phi_ = 0.03;  // Radar measurement noise standard deviation angle in rad
	std_rad_rd_ = 0.3;  // Radar measurement noise standard deviation radius change in m/s
